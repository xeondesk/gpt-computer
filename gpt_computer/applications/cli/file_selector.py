...
It operates within the GPT-Computer environment, relying on core functionalities for
...
from gpt_computer.core.default.paths import metadata_path
from gpt_computer.core.files_dict import FilesDict
from gpt_computer.core.git import filter_by_gitignore, is_git_repo
...
class FileSelector:
    ...
    COMMENT = (
        ...
        "# gpt-computer can only read selected files. "

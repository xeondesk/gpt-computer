...
for the purpose of analysis and to improve the gpt-computer system. The data is sent
...
Dependencies:
    ...
    gpt_computer.core: Core functionalities of gpt-computer.
    gpt_computer.cli.learning: Handles the extraction of learning data.

Notes:
    Data sent to RudderStack is not shared with third parties and is used solely to
    improve gpt-computer and allow it to handle a broader range of use cases.
    Consent logic is in gpt_computer/learning.py.
"""
...
def send_learning(learning: Learning):
    ...
    improving gpt-computer, and letting it handle more use cases.
    Consent logic is in gpt_computer/learning.py.
    """
    import rudderstack.analytics as rudder_analytics

    rudder_analytics.write_key = "2Re4kqwL61GDp7S8ewe6K5dbogG"
    rudder_analytics.dataPlaneUrl = "https://gptcomputerezm.dataplane.rudderstack.com"

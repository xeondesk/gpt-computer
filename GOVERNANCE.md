# Governance Model of GPT-Computer

## I. Project Board Structure

### Project Board

The Project Board is the central decision-making body for the project, overseeing both strategic and technical decisions of the open source project GPT-Computer.

#### Composition:
- The Board consists of the project's founder, Md Sulaiman, and representatives from each significant contributing entity, including individual contributors and commercial partners.
...
- To qualify as an active contributor, a board member or the entity they represent, must have made 6 significant contributions on the GPT-Computer GitHub page over the past 90 days.
...
- Any confidential data collected by GPT-Computer is accessible to the board members after signing a relevant non-disclosure agreement (NDA).
...
- An essential technical topic is a change in the GPT-computer code base that is likely to introduce breaking changes, or significantly change the user experience for users and developers.
...
## VIII. The GPT-Computer Brand

### Copyright and Stewardship
- The creator of GPT-computer (Md Sulaiman) will be the steward of the GPT-computer brand to decide when and how it can be used, and is committed to never jeopardizing the interest of the open source community in this stewardship.
- Md Sulaiman possesses the exclusive intellectual property rights for the trademark 'GPT-computer,' encompassing all case variations such as 'gpt-computer,' 'GPT-computer,' and 'GPTE.' This ownership extends to the exclusive legal authority to utilize the 'GPT-computer' trademark in the establishment and branding of both commercial and non-profit entities. It includes, but is not limited to, the use of the trademark in business names, logos, marketing materials, and other forms of corporate identity. Any use of the 'GPT-computer' trademark, in any of its case variations, by other parties for commercial or non-commercial purposes requires express permission or a license agreement from Md Sulaiman.

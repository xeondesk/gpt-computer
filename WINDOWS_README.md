...
On Windows, follow the standard [README.md](https://github.com/xeondesk/gpt-computer/blob/main/README.md), but to set API key do one of:
...
Run `pip install gpt-computer` in the command line as an administrator

Or:

  1. Open your web browser and navigate to the Python Package Index (PyPI) website: <https://pypi.org/project/gpt-computer/>.
  2. On the PyPI page for the gpt-computer package, locate the "Download files" section. Here you'll find a list of available versions and their corresponding download links.
  3. Identify the version of gpt-computer you want to install and click on the associated download link. This will download the package file (usually a .tar.gz or .whl file) to your computer.
  ...
  9. Browse and select the downloaded gpt-computer package file from your computer.

For **development**:

- `git clone git@github.com:xeondesk/gpt-computer.git`
- `cd gpt-computer`
- `poetry install`
...
- `gpt-computer projects/my-new-project`
  - (Note, `gpt-computer --help` lets you see all available options. For example `--steps use_feedback` lets you improve/fix code in a project)

By running gpt-computer you agree to our [ToS](https://github.com/xeondesk/gpt-computer/blob/main/TERMS_OF_USE.md).

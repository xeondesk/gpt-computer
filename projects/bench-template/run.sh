...
# Define the name of the temporary results file exported by gpt-computer for a single run
...
#   "bench" is the executable for the benchmarks that is installed by gpt-computer
